package com.incs870.contentdetector.action;

import static com.incs870.contentdetector.Constant.LOCATION_API_KEY;
...
import com.incs870.contentdetector.ContentDetector;
import com.incs870.contentdetector.models.Detector;
import com.incs870.contentdetector.models.GeoResponse;
import com.incs870.contentdetector.retrofitservices.LocationService;
...
public class CallToAction {
    ...
    public static final String getIpAddress(final Context context) {
    ...
    public static Observable<GeoResponse> requestResponseFromIp(LocationService locationService) {
        final String ipAddress = getIPAddress(true);
        return locationService.getLocationResponse(ipAddress, LOCATION_API_KEY);
    }

    public static Disposable sendUserInfoForSA(final Detector detector) {
